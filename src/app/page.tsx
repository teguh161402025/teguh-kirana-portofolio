    ...
    <main className="flex flex-col lg:fullpage-container h-screen">
      ...
      <div id='1' className='lg:absolute w-full section'>
        <div className='lg:container lg:mx-auto  lg:flex lg:flex-row '>
          <div className='bg-primary lg:min-h-screen h-screen lg:w-2/3 w-full relative'>
            ...
            <div className='md:pl-24 md:pt-32 self-end lg:pt-20 xl:pt-12 pt-24 px-12 lg:mt-24 xl:mt-44 relative'>
              <AnimateScroll doAfter={300} animation='fade-in-slide-up' className='opacity-0'>
                <p className='xl:text-6xl lg:text-5xl text-4xl font-bold text-ornament text-center lg:text-left '>
                  HEY I AM
                </p>
                <p className='xl:text-7xl lg:text-5xl md:text-2xl text-4xl font-bold text-secondary text-center lg:text-left'>
                  TEGUH KIRANA.
                </p>

                <p className='w-68 text-secondary xl:text-2xl lg:text-lg text-md mt-6 p-4 leading-loose lg:w-2/3 text-center lg:text-justify' >
              ...
              <div className='xl:hidden space-x-8 p-4 mt-4 flex flex-row justify-center lg:justify-start' >
          ...
          <div className='absolute left-[58%] xl:left-1/2 xl:ml-72 top-44 z-10 hidden lg:block' >


            <Image className='lg:block hidden lg:w-64 xl:w-[300px] h-auto'
              src="/assets/author-photo.png"
              alt="Image"
              width={300}
              height={300}
      ...
      <div id='3' className='lg:min-h-screen bg-primary w-full section lg:py-0 py-4'>
        <div className='container mx-auto lg:w-3/4 xl:mt-24 mt-12 w-full flex justify-center lg:block '>
          <div className='md:flex md:flex-row bg-secondary min-h-[520px] lg:h-[520px] xl:h-[600px] '>
            <div className='p-8 md:mx-8 xl:my-24 mx-6 md:my-12 md:w-1/2 lg:w-[45%] md:border-r-2 border-r-primary'>
              <AnimateScroll doAfter={300} animation='fade-in-slide-up'>
            ...
            <div className='md:flex-1 relative flex items-center justify-center p-8'>
