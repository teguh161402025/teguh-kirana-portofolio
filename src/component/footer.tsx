...
const Footer = () => {
    return (
        <div className='lg:fullpage-container h-screen  w-full bg-primary text-secondary p-8 xl:p-36'>
            <div className='lg:text-2xl space-y-8 w-full'>
                ...
                <AnimateScroll doAfter={600} animation='fade-in-slide-up'>
                    <div className='lg:w-2/3 xl:w-1/2 lg:flex flex-row justify-between space-y-8 lg:space-y-0 mb-24'>
                        ...
                        <ul className='lg:text-lg space-y-4 lg:space-y-12'>
